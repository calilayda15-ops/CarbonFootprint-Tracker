...
Automated Decision Logic: Uses if-else algorithms to flag high-risk shipments. 
Data Visualization: Professional bar charts using Matplotlib. 
📊 Technical Details 
English: The system compares total emissions against a 500,000g carbon limit. If the emission exceeds the limit, the system triggers a "High Carbon Risk" alert.
